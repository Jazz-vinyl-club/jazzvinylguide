# Idle Moments on Vinyl: The Definitive Pressing Guide
...
The title track's now-legendary length came from a genuine studio accident rather than a deliberate artistic choice. Pearson, who wrote it, noted in his liner notes that with three other tracks already recorded that night, "Idle Moments" needed to stay under seven minutes to avoid overrunning the LP's playing time. According to widely circulated accounts of the session, a miscommunication over the tune's chorus length – whether it ran 16 or 32 bars – led Green to solo for 64 bars instead of 32; Henderson, Pearson, and Hutcherson, following the shape Green had set, each extended their own solos to match. Pearson's liner notes describe the outcome simply: the musicians "became so involved in the mood of the piece that they stretched it out to almost fifteen minutes." The result ran nearly 15 minutes, an unheard-of length for a Blue Note track at the time. Alfred Lion liked the take enough to consider it finished, floated the idea of a tighter retake to fit the format, and then abandoned that idea once it became clear the original had a feeling nobody could reproduce on command.
...
- Discogs (master): [https://www.discogs.com/master/163276-Grant-Green-Idle-Moments](https://www.discogs.com/master/163276-Grant-Green-Idle-Moments)
- Wikipedia, "Idle Moments": [https://en.wikipedia.org/wiki/Idle_Moments](https://en.wikipedia.org/wiki/Idle_Moments)
- LondonJazzCollector, "Grant Green 'Idle Moments' (1963)": [https://londonjazzcollector.wordpress.com/2012/03/31/grant-green-idle-moments-1963/](https://londonjazzcollector.wordpress.com/2012/03/31/grant-green-idle-moments-1963/)
- Discogs release and community listings for all pressings referenced in the tier table above (original BLP 4154/BST 84154, AP 45rpm, Music Matters 45rpm and 33⅓ SRX, Blue Note Classic Vinyl, Blue Note 75th Anniversary, Liberty-era reissue)
- YouTube, 45 RPM Audiophile, "Shootout: Grant Green, Idle Moments + Kenny Burrell, Midnight Blue": [https://www.youtube.com/watch?v=wKnJ2Ci3fXM](https://www.youtube.com/watch?v=wKnJ2Ci3fXM)
- YouTube, Jazz Vinyl Audiophile Ken Micallef, "GRANT GREEN 'Idle Moments' KENNY BURRELL 'Midnight Blue' REVIEWED": [https://www.youtube.com/watch?v=ZXWFEfkcXTY](https://www.youtube.com/watch?v=ZXWFEfkcXTY)