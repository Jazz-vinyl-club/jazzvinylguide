...
Matrix: **P-7510A1 ST-A-59175 H** (Side A) and **P-7510A2 ST-A-59176 H** (Side B). The "H" suffix indicates the Japanese pressing plant's metalwork generation. The ST-A-59175/59176 base matrix numbers match the original 1959 AVCO lacquer codes, though whether this reflects physical metal parts transported from the US or Japanese-cut lacquers derived from the original matrix numbering is not definitively documented. Warner-Pioneer Japan typically worked from dubbed analog tape copies rather than original metalwork; the matrix codes may reflect the source tape identification rather than the physical stamper lineage.
