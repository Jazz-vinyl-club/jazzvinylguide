...
Hancock brought Carter and Williams with him from the Davis rhythm section – one of the most communicative partnerships in 1960s jazz. The rapport between all three is audible throughout: Carter anchors the unusual suspended harmonies without conventional resolution, and Williams treats the ride cymbal as a continuous melodic instrument rather than a timekeeping device.

The sus chord vocabulary that defines the album was Hancock's deliberate compositional choice. As he explained on his [official site](https://www.herbiehancock.com/music/discography/album/maiden-voyage/): "'Maiden Voyage' is a simple composition, a variation on the 32-bar song form. The harmony is based on what jazz musicians call 'sus chords'... The sus chords used in 'Maiden Voyage' are based on the dominant seventh. The inspiration for this sound came from the coda to 'Eighty-One', recorded on the Miles Davis ESP album." The result is an album that sounds harmonically suspended, unresolved, perpetually in motion – appropriate for its oceanic subject.

Alfred Lion gave Hancock considerable latitude: all five tracks are originals, the tempos are unhurried, and the recording has the quality of a composer presenting a unified conception rather than a collection of set pieces. Van Gelder at Englewood Cliffs in 1965 was in full command of the room; the recording is warm, spacious, and immediate.

**Mono vs. stereo:** Unlike many Blue Note titles where mono is the clear recommendation, *Maiden Voyage* divides opinion. Van Gelder ran parallel mono and stereo chains at the 1965 sessions, so both are native recordings. Many collectors prefer the stereo for this album specifically because the open harmonics and Williams's drum work benefit from spatial placement. As one Discogs owner notes: "I absolutely love the stereo press, most people prefer the mono, but the stereo cuts are just as special. Maybe not all the stereo cuts from this time but this one is fantastic." The LJC characterisation of the Classic Vinyl series as "lifeless" compared to originals applies to any resolving system; for most listeners, the modern Kevin Gray cuts are very good.

**Tape provenance:** The original Alfred Lion–era tapes are in the Blue Note/Universal archive – but with an unusual history. [Stereophile's review of the Music Matters pressing](https://www.stereophile.com/content/herbie-hancock-maiden-voyage) noted that the original master tapes "were misfiled long ago and were only recently rediscovered" before the Music Matters session. Both Music Matters and the Classic Vinyl series sourced from the original analogue master tapes once located.
...
The New York USA label pressings (1965–67) are the correct target:
...
- Mono matrix: **BNLP-4195-A VAN GELDER P** / **BNLP-4195-B VAN GELDER P**
...
**1980s Blue Note/EMI reissues (non-Japanese):** Various European and US reissues from the 1980s were cut from digital transfers or secondary tape sources. Not recommended when the Classic Vinyl is available at a lower price.

**Blue Note 75th Anniversary pressing (2014):** Several Discogs reviewers document warping, off-centre pressings, and audible non-fill on this title. Avoid – the Classic Vinyl is superior and cheaper.
