...
The title arrived in a Teo Macero memo to Columbia in November 1969: "Miles just called and said he wants this album to be titled: BITCHES BREW. Please advise." Davis gave the musicians simple chord sketches and directed from within the ensemble during the sessions, signalling with snaps or pointing at soloists. In his autobiography he described the process: "I would direct, like a conductor, once we started to play... While the music was developing I would hear something that I thought could be extended or cut back. So that recording was a development of the creative process, a living composition." The eight-track recording – engineered by Stan Tonkel – captured everything without stopping tape, giving Macero the raw material to work with over the following months.

The album peaked at No. 35 on the Billboard 200 – Davis's highest-charting album – won the Grammy Award for Best Large Jazz Ensemble Album in 1971, was inducted into the Grammy Hall of Fame in 1999, became his first gold-certified album (1976), reached platinum in 2003, and in 2025 was added to the Library of Congress National Recording Registry. The post-production was as much composition as engineering. Macero had studied at Juilliard and brought familiarity with musique concrète to the Columbia editing room. He cut tape with a razor blade, reassembled sections from different days, built loops from 15- and 31-second fragments, and applied echo and reverb via a custom tape-delay device built by Columbia technicians called the **"Teo One"** (also referred to as "Teo-I" in some accounts). The stop-start theme that opens "Pharaoh's Dance" was constructed entirely in post-production; it was never played in the studio. Davis and Macero disagreed – sometimes loudly – over credit. Davis wrote: "Some people have written that doing Bitches Brew was Teo Macero's idea. That's a lie." Macero responded: "Miles always wanted to take the credit for everything." The truth lay between them: neither would have made the album without the other.

**The Mati Klarwein cover:** The painting on the front – one of the most striking covers in jazz – is by German-born artist **Mati Klarwein**, also responsible for Santana's *Abraxas* cover the same year. The gatefold interior features further Klarwein artwork. Columbia agreed to this Afro-futurist imagery as part of their broader commitment to promoting Davis to a new, younger audience.

**The 1998 remix question:** The 1998 Complete Bitches Brew Sessions box set includes a remixed version of the album, not simply a remaster. Macero was invited to participate but declined after an initial meeting. When preparing the box, engineers found the eight-track masters had deteriorated – "actual sections of tape were missing because of oxidation" – and some reconstruction was required. Whether MoFi's 2014 and 2025 pressings use the original 1970 two-track mix or draw on the 1998 work is not definitively stated by MoFi. They describe mastering from "the original master tapes" via a 1/4" / 15 IPS analog master to DSD 64 chain. Buyers who specifically want the original 1970 mix as Davis and Macero first issued it should prioritise an original pressing or early reprint.

**The DSD disclosure:** Mobile Fidelity's mastering chain for this title is: analog master tape → DSD 64 digital capture → analog console → lathe. Confirmed in 2022 as part of the broader MoFi disclosure. MoFi defends the DSD step as a transfer tool that allows working with deteriorating tapes without repeated playback; critics argue it introduces a sonic ceiling.
...
Format: double LP, gatefold with interior Klarwein artwork panel. Cover front reads: "Directions In Music By Miles Davis / Miles Davis Bitches Brew."

### The 360 Sound two-eye label

The earliest pressings use the **red "360 Sound Stereo" two-eye label** – named for the two CBS "eye" logos flanking "360 Sound." Columbia introduced the red/orange ring label shortly after, so true two-eye copies represent an early production window.

**Key identification:**
- Two CBS eye logos either side of "360 Sound STEREO"
- **GP 26** on labels and cover
- Interior gatefold: "Manufactured by Columbia Records/CBS, Inc./51 W. 52 Street, New York, N.Y."

**Pressing plant identification:** Columbia's three US plants are identified by stamped letters in the deadwax:
...
The original catalogue number is **GP 26** ("Gatefold Package"). Columbia later changed the prefix to **PG 26**. Copies with PG 26 on the cover are reprints; some transitional copies have PG 26 on the cover and GP 26 on the labels.
...
|---|---|---|---|---|---|---|---|
| **S** | MoFi UltraDisc One-Step 55th | MFSL UD1S-109 | 2025 | Stereo, 33⅓, 2×180g | Orig tapes → DSD 64 → Wunderlich, FRP | 5,000 copies; lowest noise floor | [Discogs](https://www.discogs.com/release/33848460-Miles-Davis-Bitches-Brew) |
| **A** | Original two-eye 360 Sound (TH / Pitman / SM) | GP 26 | 1970 | Stereo, 33⅓ | Original 1970 Columbia mix | –1J matrices; "T"/"P"/"S" deadwax; Sanctuary error = earliest | [TH](https://www.discogs.com/release/9782567-Miles-Davis-Bitches-Brew) · [Pitman](https://www.discogs.com/release/12032942-Miles-Davis-Bitches-Brew) · [SM](https://www.discogs.com/release/37006-Miles-Davis-Bitches-Brew) |
| **A** | Japanese CBS/Sony 28AP 2151~2 | 28AP 2151~2 | 1981 | Stereo, 33⅓, 2LP | CBS/Sony Japan; Big Jazz Fusion 23 series | 4.95/5 Discogs avg; 977 wants; dead-quiet | [Discogs](https://www.discogs.com/release/2075721-Miles-Davis-Bitches-Brew) |
| **B** | MoFi MFSL 2-439 180g 2LP | MFSL 2-439 | 2014/2023 | Stereo, 33⅓, 2×180g | Orig tapes → DSD 64 → Wunderlich, RTI/FRP | Disclosed DSD; widely praised | [Discogs](https://www.discogs.com/release/5804415-Miles-Davis-Bitches-Brew) |
| **B** | Early red/orange Columbia ring label | GP/PG 26 | 1970–75 | Stereo, 33⅓ | Period Columbia lacquer | Sonically close to two-eye | [Discogs](https://www.discogs.com/release/11481689-Miles-Davis-Bitches-Brew) |
| **C** | Quadraphonic SQ matrix | GP 26 | 1971 | Quad/stereo, 33⅓ | Original Columbia quad mix | SQ decodable; curio | [Discogs](https://www.discogs.com/release/1157814-Miles-Davis-Bitches-Brew) |
| **C** | Columbia Legacy 40th Anniversary | Various | 2010 | Stereo, 33⅓ | Digital remaster | Decent at low price | – |
