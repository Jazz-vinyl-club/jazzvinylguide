# Birth of the Cool on Vinyl: The Definitive Pressing Guide
...
The music was originally issued as individual 78rpm singles between 1949 and 1950. Eight tracks appeared on a 1954 Capitol 10" LP (H-459, "Classics in Jazz – Miles Davis"). The 1957 T-762 gathered eleven of the twelve tracks and gave the set the title "Birth of the Cool" – Capitol's own framing, applied retrospectively. The 1972 edition (M-11026) added "Darn That Dream" and has since been the template for all subsequent releases. The mono is the only authentic format: these 1949–50 recordings predate stereo; any "stereo" copy is electronic rechanneling and should be avoided. The Blue Note Tone Poet reissue (2026) is a highly regarded audiophile-grade AAA pressing from the original Capitol tapes, mastered by Kevin Gray, and is the only AAA reissue of this specific title currently confirmed to exist – no Analogue Productions edition of *Birth of the Cool* has been found despite searching; a specialist Miles Davis collecting guide from Tracking Angle explicitly has no recommendation for this title, which would be surprising if an AP edition existed. Do not confuse this with *Birth of the Blue* (2024/2025), an unrelated Analogue Productions release of different material recorded roughly a year before *Kind of Blue* by an overlapping lineup – a different album entirely, despite the similar title.

**Best early pressing for audiophiles:** [Original Capitol T-762 mono, turquoise label, "Long Playing" only](https://www.discogs.com/release/5456857-Miles-Davis-Birth-Of-The-Cool) – Scranton pressing, machine-stamped runouts.

**Best modern pressing for audiophiles:** [Blue Note Tone Poet 180g mono (2026)](https://www.discogs.com/release/37415985-Miles-Davis-Birth-Of-The-Cool-Of-The-Cool) – Kevin Gray, AAA from original Capitol phono reel tapes, RTI, gatefold.
...
The nonet grew out of informal musical discussions at arranger **Gil Evans's basement apartment on West 55th Street** in Manhattan from 1947 onward, a gathering point for musicians interested in a lighter, more harmonically complex alternative to bebop. Evans had been an arranger for the **Claude Thornhill Orchestra**, whose distinctive use of French horn and tuba Davis and Mulligan had encountered; Evans and Mulligan worked out the smallest ensemble that could replicate the Thornhill sound, settling on nine pieces. As the [Miles Davis official site](https://www.milesdavis.com/albums/birth-of-the-cool/) puts it: "nine-man group they finally settled on was a reduced version of the jazz-band-cum-orchestra-brass Thornhill model: trumpet, trombone, French horn, tuba, alto saxophone, baritone saxophone, piano, bass and drums."

In September 1948 the nonet opened for Count Basie at the **Royal Roost** on Broadway and 47th Street – Davis had insisted the marquee outside read: "Miles Davis Nonet – Arrangements by Gerry Mulligan, Gil Evans and John Lewis." Capitol A&R man and arranger **Pete Rugolo** heard them there and got them into WOR Studios to record. Davis signed his Capitol contract on **January 5, 1949**. The nonet played only one other engagement – a brief Clique Club residency – before disbanding; the recordings are effectively its entire studio legacy.

**The sessions:** The January 21, 1949 session (rhythm section: Lewis, Shulman, Roach; French horn: Junior Collins) cut "Jeru," "Godchild," "Move," and "Budo." The April 22, 1949 session (rhythm: Lewis, Boyd, Clarke; French horn: Sandy Siegelstein) cut "Venus de Milo," "Boplicity," "Israel," and "Rouge." The March 9, 1950 session (no piano; French horn: Gunther Schuller; bass: McKibbon) cut "Moon Dreams," "Deception," "Rocker," and "Darn That Dream." The absence of piano on the final session gives "Moon Dreams" and "Deception" their particularly unusual timbral quality.

**Track notes:** "Boplicity" was composed by Davis and Evans but credited on the label to **"Cleo Henry"** – the maiden name of Davis's mother – as a publishing pseudonym. Gil Evans arranged it; [André Hodeir wrote](https://www.everythingjazz.com/story/the-making-of-miles-davis-birth-of-the-cool/) that "'Boplicity' is enough to make Gil Evans qualify as one of jazz's greatest arranger-composers." "Israel" is the only blues among the twelve tracks; John Carisi arranged his own composition. "Moon Dreams" – Evans's arrangement of a Chummy MacGregor melody – is the most orchestral piece and gives the clearest preview of how Davis and Evans's later collaborations (*Miles Ahead*, *Porgy and Bess*, *Sketches of Spain*) would sound.

The sessions were largely underappreciated at the time. Capitol was disappointed with sales and did not offer Davis a contract extension. [Wikipedia notes](https://en.wikipedia.org/wiki/Birth_of_the_Cool) that one critic later hailed the nonet's music as summarising "the whole achievement of modern jazz up to that point" – recognition that came years after the fact.

**Tape provenance:** The original Capitol tapes – mono recordings to acetate disc from 1949–50, later transferred to tape – are held in the Capitol/UMG archive. The Tone Poet's Joe Harley has described the tapes as being in excellent condition given their age. All three sessions were recorded at WOR Studios under standard late-1940s New York conditions; the recording quality for the era is high. Discogs owners of the Tone Poet: "If you didn't know that these recordings were made in 1949, you'd never believe it."

**The 1957 compilation:** Capitol T-762 gathered eleven of the twelve tracks (excluding "Darn That Dream," the vocal with Kenny Hagood). The title "Birth of the Cool" was Capitol's marketing framing, applied retrospectively; the musicians did not use it. The 1972 M-11026 edition added "Darn That Dream" and has been the standard template for reissues since, including the Tone Poet.

---

## Original Capitol pressings

**Catalogue: T-762** (mono, 12" LP, 1957)

### First pressing – turquoise label, "Long Playing" only

The earliest identified copies:
- **Turquoise label** with Capitol dome logo at top
...
### Second pressing – "Long Playing High Fidelity" label

The second pressing (still turquoise, 1957–58) adds "High Fidelity" to the base text. The rim text may differ slightly. Sonically equivalent to the first pressing; considerably more common.

### Later Capitol pressings (1960s onward)

Capitol's label design evolved through the 1960s. The orange-and-yellow "swirl" logo was adopted mid-1960s. These use later metalwork and are not generally preferred by serious collectors, though some early 1960s copies from first-generation metal have been favourably reviewed.
...
- WRTI, "A Miles Davis masterpiece gets a hi-fi prequel with 'Birth of the Blue'": [https://www.wrti.org/arts-desk/2024-11-13/a-miles-davis-masterpiece-gets-a-hi-fi-prequel-with-birth-of-the-blue](https://www.wrti.org/arts-desk/2024-11-13/a-miles-davis-masterpiece-gets-a-hi-fi-prequel-with-birth-of-the-blue)
